...
inline chain<T> merge(chain<T> &a, chain<T> &b){
    ...
    while(ita != a.end() && itb != b.end()){
        if (*ita.element < *itb.element)
            res.push_back(*itb.element), itb++;
        else 
            res.push_back(*ita.element), ita++;
    }
    while(ita != a.end()) res.push_back(*ita.element), ita++;
    while(itb != b.end()) res.push_back(*itb.element), itb++;
    return res;
}
...
void chain<T>::merge(chain<T> &a, chain<T> &b){
    ...
    while(ita != a.end() && itb != b.end()){
        if (*ita.element < *itb.element) 
            push_back(*itb.element), itb++;
        else 
            push_back(*ita.element), ita++;
    }
    while(ita != a.end()) push_back(*ita.element), ita++;
    while(itb != b.end()) push_back(*itb.element), itb++;
    a.clear(), b.clear();
}
int main()
{
